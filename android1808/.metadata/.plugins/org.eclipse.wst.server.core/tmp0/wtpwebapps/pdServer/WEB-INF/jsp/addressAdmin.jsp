		...
		<div class="rightsidebar_box rt">
			...
			<div class="rs_content">
				...
				<div class="address_information_manage">
					...
					<c:forEach items="${list}" var="ajiaShipping">
					<div class="aim_content_one ${ajiaShipping.isDefault?'aim_active':'' }">
						<span class="dzmc ${ajiaShipping.isDefault?'dzmc_active':'dzmc_normal' }"">办公室</span> <span
							class="dzxm dzxm_normal">
							${ajiaShipping.receiverName}							
							</span> 
							<span class="dzxq dzxq_normal">
							${ajiaShipping.receiverState}
							${ajiaShipping.receiverCity}
							${ajiaShipping.receiverDistrict}
							${ajiaShipping.receiverAddress}
							</span>
						<span class="lxdh lxdh_normal">
						${ajiaShipping.receiverPhone}</span> <span
							class="operation operation_normal"> <span
							class="aco_change">修改</span>|
							<span id="${ajiaShipping.addId}" 
							class="aco_delete">删除</span>
						</span> 
						<!-- 以data开头，浏览器不做任何处理，给js用 -->
						<span class="swmr swmr_normal"
						data_addressId="${ajiaShipping.addId}"
						>
						${ajiaShipping.isDefault?"":"设为默认"}
						</span>
					</div>
					</c:forEach>
