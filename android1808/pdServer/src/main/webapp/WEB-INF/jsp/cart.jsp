        ...
        <div id="box" >
            <div id="content_box">
                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${itemVO.ajiaItem.id}">
                        
                            <img src="../images/cart/product_simg1.png" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                            ${itemVO.ajiaItem.model}
                            ${itemVO.ajiaItem.title}
                              <input type="hidden" name="" value="">
                        </span>
                    ...
                    <div class="pices">
                        ...
                        <span>${itemVO.ajiaItem.price}  <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num">
                    <span class="reduc">&nbsp;-&nbsp;</span>
                    <input type="text" value="${itemVO.ajiaCartItem.num}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${itemVO.ajiaCartItem.num*itemVO.ajiaItem.price}</span>
                    </div>
                    <div class="del">
                        <!-- <div>
