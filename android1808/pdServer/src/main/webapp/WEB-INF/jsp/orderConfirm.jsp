...
${itemVO.ajiaItem.title}
                ...
                <li class="p_price">
                    ...
                    <span class="ppp_price">${itemVO.ajiaItem.price }</span></span>
                </li>
                <li class="p_count">X<span>${itemVO.ajiaCartItem.num}</span></li>
