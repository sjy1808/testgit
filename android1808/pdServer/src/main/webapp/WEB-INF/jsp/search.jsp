	...
	<div class="big">
		<form name="" action="" method="post">
			<section id="section">
				...
				<div id="content_box">
				<c:forEach items="${list}" var="ajiaItemSolr">
					<div class="lf" id="d1">
						<div class="img">
						<!-- ../images/search/product_img.png -->
							<img src="${ajiaItemSolr.image}" alt="" onclick="toItemInfo(${ajiaItemSolr.itemId})" />
						</div>			
						<div class="describe">
							<p onclick="toItemInfo(${ajiaItemSolr.itemId})">
							${ajiaItemSolr.model}
							${ajiaItemSolr.title}
							</p>
							<span class="price"><b>￥</b>
							<span class="priceContent">
							${ajiaItemSolr.price}</span></span>
